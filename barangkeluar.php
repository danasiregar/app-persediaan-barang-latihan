...
<html lang="en">
    ...
    <body>
        ...
        <div class="container";>
            ...
            <a href="barangkeluartambah.php"><button class="btn btn-primary" type="button">Tambah Barang Keluar
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="barangkeluaredit.php?id=<?php echo $data['Id']; ?>">
                        <button class="btn-warning">Ubah</button></a>
                        <a href="barangkeluarhapus.php?id=<?php echo $data['Id']; ?>">
