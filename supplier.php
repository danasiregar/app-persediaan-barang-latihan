...
<html lang="en">
    ...
    <body>
        ...
        <div class="container";>
            <h2>Data Supplier</h2>
            <a href="suppliertambah.php"><button class="btn btn-primary" type="button">Tambah Supplier
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="supplieredit.php?id=<?php echo $data['KodeSupplier']; ?>">
                        <button class="btn-warning">Ubah</button></a>
                        <a href="supplierhapus.php?id=<?php echo $data['KodeSupplier']; ?>">
