<?php
    ...
    if(isset($_POST['btnsimpan'])=='btnsimpan'){
        ...
        if($totaldata <> 0) {
            ...
            echo "<script>window.location.href='barangmasuktambah.php'</script>";
        }else{
            $query_sql = "INSERT INTO tb_barang_masuk (KodeBarangMasuk, Nama, Tanggal, KodeSupplier, KodeBarang, Jumlah, Satuan, Petugas)
            VALUES ('$KodeBarangMasuk', '$Nama', '$Tanggal', '$KodeSupplier', '$KodeBarang', $Jumlah, '$Satuan', '$Petugas');";
            $sql = mysqli_query($koneksidb, $query_sql) or die(mysqli_error($koneksidb));
            if($sql){
                        ...
                        <div class="row form-group">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="KodeBarangMasuk" class="form-control">
                                </div>
                                <div class="form-group">
