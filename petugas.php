...
<body>
    ...
    <div class="container">
        <h2>Data Petugas</h2>
        <a href="petugastambah.php"><button class="btn btn-primary" type="button">Tambah Petugas
        ...
        <table align="table-responsive" class="table table-striped table-bordered table-hover" id="dynamic-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="petugasedit.php?id=<?php echo $data['KodePetugas']; ?>">
                        <button class="btn-warning">Ubah</button></a>
                        <a href="petugashapus.php?id=<?php echo $data['KodePetugas']; ?>">
