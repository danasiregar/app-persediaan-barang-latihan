<?php
    ...
    $query_sql = "SELECT * FROM tb_barang_masuk";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container";>
            ...
            <a href="barangmasuktambah.php"><button class="btn btn-primary" type="button">Tambah Barang Masuk
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="barangmasukedit.php?id=<?php echo $data['KodeBarangMasuk']; ?>">
                        <button class="btn-warning">Ubah</button></a>
                        <a href="barangmasukhapus.php?id=<?php echo $data['KodeBarangMasuk']; ?>">
                        <button class="btn-danger">Hapus</button></a>
                    </td>
                    <td><?php echo $data['KodeBarangMasuk']; ?></td>
